...
/****************************************************************************************/
add_action( 'ambition_footer', 'ambition_footer_infobar', 18 );
function ambition_footer_infobar() { 
	...
	$contact_info_bar_buttom = $ambition_settings['contact_info_bar_buttom'];
	if (($phone_no !='' || $email_id!='' || $location != '' || $skype !='') && $contact_info_bar_buttom ==0){ ?>
	<div class="info-bar">
		<div class="container clearfix">
			<?php ambition_footer_infoblog(); ?>
		</div><!-- .container -->
	</div><!-- .info-bar -->
<?php }
}
...
function ambition_footer_info() {  
	...
	global $foot_edit;
	$foot_edit = $ambition_settings['ambition_fott_edit'];   
	$ambition_footer_info = '<div class="copyright">'.$foot_edit.'</div><!-- .copyright -->';
		echo $ambition_footer_info;
}
/****************************************************************************************/
