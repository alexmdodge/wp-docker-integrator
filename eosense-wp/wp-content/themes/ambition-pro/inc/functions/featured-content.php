 ...
 */
class Ambition_Featured_Contents {
	/**
	 ...
	 *
	 * @see Ambition_Featured_Contents::init()
	 */
	 ...
	 *
	 * @see Ambition_Featured_Contents::validate_settings().
	 */
	 ...
	 * the transient is deleted by Ambition_Featured_Contents::validate_settings().
	 *
	 ...
	 *
	 * @uses Ambition_Featured_Contents::get_setting()
	 */
	...
	public static function customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'featured-content[tag-name]', array(
			'default'              => _x( 'featured', 'featured content default tag slug', 'ambition' ),
			'type'                 => 'option',
		...
		$wp_customize->add_control( 'featured-content[tag-name]', array(
			'label'    => __( 'Tag Name', 'ambition' ),
			'section'  => 'featured_content',
			'priority' => 20,
		) );
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'    => __( 'Don&rsquo;t display tag on front end.', 'ambition' ),
			'section'  => 'featured_content',
			'type'     => 'checkbox',
			'priority' => 30,
		) );
	...
	public static function enqueue_scripts() {
		wp_enqueue_script( 'featured-content-suggest', get_template_directory_uri() . '/inc/admin/js/featured-content-admin.js', array( 'jquery', 'suggest' ), '20131022', true );
	}
	...
	public static function get_setting( $key = 'all' ) {
		...
		$defaults = array(
			'hide-tag' => 1,
			'tag-id'   => 0,
			'tag-name' => _x( 'featured', 'featured content default tag slug', 'ambition' ),
		);
...
} // Ambition_Featured_Contents

Ambition_Featured_Contents::setup();
